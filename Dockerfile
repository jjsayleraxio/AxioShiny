...
LABEL author="Joseph Sayler" email="josephs@axioresearch.com" company="Axio Research" version="1.2"

RUN Rscript -e "install.packages(c('ggplot2','Cairo','shiny','DBI','RSQLite','plotly','manhattanly','data.table','hexbin','webshot','shinyBS','htmlwidgets','DT','shinyhelper','dbplyr','shinydashboard','shinyjs','gtools','ggvis','gridExtra','magrittr','plumber'))" \
